...
/** source: /__app__/app/ui/Datagrid/template.latte */
final class Template591a2f76be extends Latte\Runtime\Template
{
...
';
	...
	public function prepare(): void
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === "extends") {
			foreach (array_intersect_key(['f' => '43', 'form_control' => '79', 'toolbar_button' => '98', 'export' => '102', 'v_key' => '115', 'visibility' => '115', 'key' => '145, 202, 255, 289, 298, 426, 474, 487', 'column' => '145, 202, 255, 289, 426, 474, 487', 'inlineEditControl' => '263', 'action' => '298', 'row' => '245', 'inlineAddControl' => '434'], $this->params) as $ʟ_v => $ʟ_l) {
...
';
		...
		foreach ($iterator = $ʟ_it = new LR\CachingIterator($columns, $ʟ_it ?? null) as $key => $column) /* line 145 */ {
			...
			$th->class = "text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 pe-2 text-" . $column->getAlign() /* line 147 */;
			echo '							';
...
';
	...
	/** {block icon-arrows-v} on line 308 */
	public function blockIcon_arrows_v(array $ʟ_args): void
	{
		...
		unset($ʟ_args);
		echo '												<i class="';
		echo LR\Filters::escapeHtmlAttr($iconPrefix) /* line 308 */;
		echo 'arrows-v ';
		echo LR\Filters::escapeHtmlAttr($iconPrefix) /* line 308 */;
		echo 'arrows-alt-v"></i>
';
	...
	public function blockNoItems(array $ʟ_args): void
	{
		...
		if (!$rows) /* line 365 */ {
			echo '							<tr>
								<td colspan="';
			echo LR\Filters::escapeHtmlAttr($control->getColumnsCount()) /* line 366 */;
			echo '">
';
			if ($filter_active) /* line 367 */ {
				echo '										';
				echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.no_item_found_reset')) /* line 368 */;
				echo ' <a class="link ajax" href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("resetFilter!")) /* line 368 */;
				echo '">';
				echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.here')) /* line 368 */;
				echo '</a>.
';
			} else /* line 369 */ {
				echo '										';
				echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.no_item_found')) /* line 370 */;
				echo "\n";
			}
			echo '								</td>
							</tr>
...
';
	...
	public function blockPagination(array $ʟ_args): void
	{
		...
		echo '							<tr>
';
		if (!$control->isTreeView()) /* line 382 */ {
			echo '								<td colspan="';
			echo LR\Filters::escapeHtmlAttr($control->getColumnsCount()) /* line 382 */;
			echo '" class="row-grid-bottom bg-transparent border-0">
									<div class="col-items">
';
			if ($control->isPaginated()) /* line 384 */ {
				echo '										<small class="text-muted">
											(';
				$paginator = $control['paginator']->getPaginator() /* line 385 */;
				echo '

';
				if ($control->getPerPage() === 'all') /* line 387 */ {
					echo '												';
					echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.items')) /* line 388 */;
					echo ': ';
					echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.all')) /* line 388 */;
					echo "\n";
				} else /* line 389 */ {
					echo '												';
					echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.items')) /* line 390 */;
					echo ': ';
					echo LR\Filters::escapeHtmlText($paginator->getOffset() > 0 ? $paginator->getOffset() + 1 : ($paginator->getItemCount() > 0 ? 1 : 0)) /* line 390 */;
					echo ' - ';
					echo LR\Filters::escapeHtmlText(sizeof($rows) + $paginator->getOffset()) /* line 390 */;
					echo '
												';
					echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.from')) /* line 391 */;
					echo ' ';
					echo LR\Filters::escapeHtmlText($paginator->getItemCount()) /* line 391 */;
					echo '
											';
				}
				echo ')
...
';
			/* line 396 */ $_tmp = $this->global->uiControl->getComponent("paginator");
...
';
			if ($control->isPaginated()) /* line 399 */ {
				...
				echo $ʟ_input->getControl()->addAttributes(['data-autosubmit-per-page' => TRUE, 'class' => 'form-control input-sm form-control-sm ps-2 pe-2']) /* line 401 */;
				echo '
											';
				$ʟ_input = $_input = is_object($filter['perPage_submit']) ? $filter['perPage_submit'] : end($this->global->formsStack)[$filter['perPage_submit']];
				echo $ʟ_input->getControl()->addAttributes(['class' => 'datagrid-per-page-submit']) /* line 402 */;
				echo '
											záznamů
';
				if ($filter_active) /* line 404 */ {
					echo '											<a class="ajax btn btn-danger btn-sm reset-filter ms-3 mb-0" href="';
					echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("resetFilter!")) /* line 404 */;
					echo '">';
					echo LR\Filters::escapeHtmlText(($this->filters->translate)('ublaboo_datagrid.reset_filter')) /* line 404 */;
					echo '</a>
';
				}
			}
...
';
	...
	/** {define inlineAddRow} on line 419 */
	public function blockInlineAddRow(array $ʟ_args): void
	{
		extract($this->params);
		extract($ʟ_args);
		unset($ʟ_args);
		if ($inlineAdd->shouldBeRendered()) /* line 420 */ {
			$inlineAdd->onSetDefaults($filter['inline_add']) /* line 421 */;
			echo '
		<tr class="datagrid-row-inline-add datagrid-row-inline-add-hidden">
';
			if ($hasGroupActions) /* line 424 */ {
				echo '			<td class="col-checkbox"></td>
';
			}
			echo "\n";
			$iterations = 0;
			foreach ($columns as $key => $column) /* line 426 */ {
				$col = 'col-' . $key /* line 427 */;
				echo "\n";
				$td = clone $column->getElementForRender('td', $key) /* line 429 */;
				$td->class[] = 'datagrid-inline-edit' /* line 430 */;
				echo '				';
				echo $td->startTag() /* line 431 */;
				echo "\n";
				if (isset($filter['inline_add'][$key])) /* line 432 */ {
					if ($filter['inline_add'][$key] instanceof \Nette\Forms\Container) /* line 433 */ {
						$iterations = 0;
						foreach ($filter['inline_add'][$key]->getControls() as $inlineAddControl) /* line 434 */ {
							echo '								';
						...
						echo $ʟ_input->getControl() /* line 438 */;
						echo "\n";
					}
				}
				echo '				';
				echo $td->endTag() /* line 441 */;
				echo "\n";
				$iterations++;
			}
			echo '
			...
			echo $ʟ_input->getControl() /* line 445 */;
			echo '
				';
...
';
	...
	/** {define columnSummary} on line 453 */
	public function blockColumnSummary(array $ʟ_args): void
	{
		...
		unset($ʟ_args);
		echo "\n";
		if (!empty($rows) && ($columnsSummary || $control->hasSomeAggregationFunction())) /* line 455 */ {
...
';
	...
	/** {define columnsSummary} on line 472 */
	public function blockColumnsSummary(array $ʟ_args): void
	{
		...
		echo "\n";
		$iterations = 0;
		foreach ($columns as $key => $column) /* line 474 */ {
			$td = $column->getElementForRender('td', $key) /* line 475 */;
			echo '
		';
			echo $td->startTag() /* line 477 */;
			echo '
			';
			echo LR\Filters::escapeHtmlText($columnsSummary->render($key)) /* line 478 */;
			echo '
		';
			echo $td->endTag() /* line 479 */;
			echo "\n";
			$iterations++;
		}
		echo "\n";
	...
	/** {define aggregationFunctions} on line 485 */
	public function blockAggregationFunctions(array $ʟ_args): void
	{
		...
		echo "\n";
		$iterations = 0;
		foreach ($columns as $key => $column) /* line 487 */ {
			$td = $column->getElementForRender('td', $key) /* line 488 */;
			echo '
		';
			echo $td->startTag() /* line 490 */;
			echo "\n";
			if ($aggregationFunctions) /* line 491 */ {
				if (isset($aggregationFunctions[$key])) /* line 492 */ {
					echo '					';
					echo $aggregationFunctions[$key]->renderResult() /* line 493 */;
					echo "\n";
				}
			} else /* line 495 */ {
				echo '				';
				echo $multipleAggregationFunction->renderResult($key) /* line 496 */;
				echo "\n";
			}
			echo '		';
			echo $td->endTag() /* line 498 */;
			echo "\n";
			$iterations++;
		}
		echo "\n";
	...
	/** {define column-header} on line 504 */
	public function blockColumn_header(array $ʟ_args): void
	{
		extract($this->params);
		extract($ʟ_args);
		unset($ʟ_args);
		if (!$column->isHeaderEscaped()) /* line 505 */ {
			if ($column instanceof \Nette\Utils\Html || !$column->isTranslatableHeader()) /* line 506 */ {
				echo '			';
				echo $column->getName() /* line 507 */;
				echo "\n";
			} else /* line 508 */ {
				echo '			';
				echo ($this->filters->translate)($column->getName()) /* line 509 */;
				echo "\n";
			}
		} else /* line 511 */ {
			if ($column instanceof \Nette\Utils\Html || !$column->isTranslatableHeader()) /* line 512 */ {
				echo '			';
				echo LR\Filters::escapeHtmlText($column->getName()) /* line 513 */;
				echo "\n";
			} else /* line 514 */ {
				echo '			';
				echo LR\Filters::escapeHtmlText(($this->filters->translate)($column->getName())) /* line 515 */;
				echo "\n";
			}
		}
	...
	/** {define column-value} on line 521 */
	public function blockColumn_value(array $ʟ_args): void
	{
		extract($this->params);
		extract($ʟ_args);
		unset($ʟ_args);
		$col = 'col-' . $key /* line 522 */;
		$item = $row->getItem() /* line 523 */;
		echo "\n";
		if ($column->hasTemplate()) /* line 525 */ {
			$this->createTemplate($column->getTemplate(), array_merge(['row' => $row, 'item' => $item, ], $column->getTemplateVariables(), []) + $this->params, 'include')->renderToContentType('html') /* line 526 */;
		} else /* line 527 */ {
			if ($this->hasBlock($col)) /* line 528 */ {
				$this->renderBlock($col, ['item' => $item] + [], 'html') /* line 529 */;
			} else /* line 530 */ {
				if ($column->isTemplateEscaped()) /* line 531 */ {
					echo '				';
					echo LR\Filters::escapeHtmlText($column->render($row)) /* line 532 */;
					echo "\n";
				} else /* line 533 */ {
					echo '				';
					echo $column->render($row) /* line 534 */;
					echo "\n";
				}
			}
		}
	...
	public function blockTable(array $ʟ_args): void
	{
		...
		try {
			...
			echo "\n";
			$this->renderBlock('tfoot', get_defined_vars()) /* line 378 */;
			echo "\n";
		} finally {
			$this->global->snippetDriver->leave();
		}
...
';
							...
							foreach ($iterator = $ʟ_it = new LR\CachingIterator($columns, $ʟ_it ?? null) as $key => $column) /* line 289 */ {
								...
								echo '											';
								echo $td->startTag() /* line 293 */;
								echo "\n";
								$this->renderBlock('column-value', ['column' => $column, 'row' => $row, 'key' => $key] + get_defined_vars(), 'html') /* line 294 */;
								echo '											';
								echo $td->endTag() /* line 295 */;
								echo "\n";
								$iterations++;
							}
							$iterator = $ʟ_it = $ʟ_it->getParent();
							if ($actions || $control->isSortable() || $itemsDetail || $inlineEdit || $inlineAdd) /* line 297 */ {
								echo '										<td class="col-action">
											';
								$iterations = 0;
								foreach ($actions as $key => $action) /* line 298 */ {
									echo "\n";
									if ($row->hasAction($key)) /* line 299 */ {
										if ($action->hasTemplate()) /* line 300 */ {
											$this->createTemplate($action->getTemplate(), array_merge(['item' => $item, ], $action->getTemplateVariables(), [ 'row' => $row]) + $this->params, 'include')->renderToContentType('html') /* line 301 */;
										} else /* line 302 */ {
											echo '														';
											echo $action->render($row) /* line 303 */;
											echo "\n";
										}
									}
									$iterations++;
								}
								if ($control->isSortable()) /* line 307 */ {
									echo '											<span class="handle-sort btn btn-xs btn-default btn-secondary">
';
									$this->renderBlock('icon-arrows-v', get_defined_vars()) /* line 308 */;
									echo '											</span>
';
								}
								if ($inlineEdit && $row->hasInlineEdit()) /* line 310 */ {
									echo '												';
									echo $inlineEdit->renderButton($row) /* line 311 */;
									echo "\n";
								}
								if ($itemsDetail && $itemsDetail->shouldBeRendered($row)) /* line 313 */ {
									echo '												';
									echo $itemsDetail->renderButton($row) /* line 314 */;
									echo "\n";
								}
								echo '										</td>
';
...
';
				...
				echo "\n";
				if ($itemsDetail && $itemsDetail->shouldBeRendered($row)) /* line 324 */ {
					echo '								<tr class="row-item-detail item-detail-';
					echo LR\Filters::escapeHtmlAttr($control->getFullname()) /* line 325 */;
					echo '-id-';
					echo LR\Filters::escapeHtmlAttr($row->getId()) /* line 325 */;
					echo '"';
					echo ' id="' . htmlspecialchars($this->global->snippetDriver->getHtmlId($ʟ_nm = "item-{$row->getId()}-detail")) . '"';
					echo '>
';
					$this->global->snippetDriver->enter($ʟ_nm, 'dynamic') /* line 325 */;
					try {
						echo '									';
						if (isset($toggle_detail) && $toggle_detail == $row->getId()) /* line 326 */ {
							echo "\n";
							$item_detail_params = ['item' => $item, '_form' => $filter] + $itemsDetail->getTemplateVariables() /* line 327 */;
							echo "\n";
							if (isset($filter['items_detail_form'])) /* line 329 */ {
								$item_detail_params['items_detail_form'] = $filter['items_detail_form'] /* line 330 */;
							}
							echo "\n";
							if ($this->hasBlock("detail")) /* line 333 */ {
								echo '											<td colspan="';
								echo LR\Filters::escapeHtmlAttr($control->getColumnsCount()) /* line 334 */;
								echo '">
												<div class="item-detail-content">
';
								$this->renderBlock('detail', array_merge([], $item_detail_params, []) + [], 'html') /* line 336 */;
								echo '												</div>
											</td>
';
							} elseif ($itemsDetail) /* line 339 */ {
								echo '											<td colspan="';
								echo LR\Filters::escapeHtmlAttr($control->getColumnsCount()) /* line 340 */;
								echo '">
												<div class="item-detail-content">
';
								if ($itemsDetail->getType() == 'template') /* line 342 */ {
									$this->createTemplate($itemsDetail->getTemplate(), array_merge([], $item_detail_params, []) + $this->params, 'include')->renderToContentType('html') /* line 343 */;
								} else /* line 344 */ {
									echo '														';
									echo $itemsDetail->render($item) /* line 345 */;
									echo "\n";
								}
								echo '												</div>
											</td>
...
';
			...
			$iterator = $ʟ_it = $ʟ_it->getParent();
			echo "\n";
			if ($inlineAdd && $inlineAdd->isPositionBottom()) /* line 356 */ {
				$this->renderBlock('inlineAddRow', ['columns' => $columns] + get_defined_vars(), 'html') /* line 357 */;
			}
			echo "\n";
			if (($columnsSummary && !$columnsSummary->getPositionTop()) || $control->hasSomeAggregationFunction()) /* line 360 */ {
				$this->renderBlock('columnSummary', get_defined_vars(), 'html') /* line 361 */;
			}
			echo "\n";
			$this->renderBlock('noItems', get_defined_vars()) /* line 364 */;
			echo "\n";
		} finally {
			$this->global->snippetDriver->leave();
		}
	...
	/** {snippet pagination} on line 379 */
	public function blockPagination1(array $ʟ_args): void
	{
		...
		try {
			echo '						';
			if ($control->isPaginated() || $filter_active) /* line 380 */ {
				echo "\n";
				$this->renderBlock('pagination', get_defined_vars()) /* line 381 */;
			}
		} finally {
			$this->global->snippetDriver->leave();
		}
	...
	public function blockSummary(array $ʟ_args): void
	{
		...
		try {
			if ($hasGroupActions) /* line 456 */ {
				echo '		<td class="col-checkbox"></td>
';
			}
			echo "\n";
			if ($columnsSummary && $columnsSummary->someColumnsExist($columns)) /* line 458 */ {
				$this->renderBlock('columnsSummary', ['columns' => $columns] + get_defined_vars(), 'html') /* line 459 */;
			}
			echo "\n";
			if ($control->hasSomeAggregationFunction()) /* line 462 */ {
				$this->renderBlock('aggregationFunctions', ['columns' => $columns] + get_defined_vars(), 'html') /* line 463 */;
			}
			echo "\n";
			if ($actions || $control->isSortable() || $itemsDetail || $inlineEdit || $inlineAdd) /* line 466 */ {
