...
final class Template996ae390a4 extends Latte\Runtime\Template
{
	...
	';
			if ($paginator->isFirst()) /* line 10 */ {
				echo '
		<a class="first btn btn-sm btn-default btn-secondary disabled mb-0">
';
			} else /* line 12 */ {
				echo '		<a class="btn btn-sm btn-default btn-secondary ajax mb-0" href="';
...
';
			...
			foreach ($iterator = $ʟ_it = new LR\CachingIterator($steps, $ʟ_it ?? null) as $step) /* line 17 */ {
				if ($step == $paginator->page) /* line 18 */ {
					echo '			<a class="first btn btn-sm btn-primary active mb-0">';
...
';
		...
		';
			...
			if ($paginator->isLast()) /* line 27 */ {
				echo '		<a class="first btn btn-sm btn-default btn-secondary disabled mb-0">';
