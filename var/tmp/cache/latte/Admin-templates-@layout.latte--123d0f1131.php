...
final class Template123d0f1131 extends Latte\Runtime\Template
{
...
';
	...
	public function blockMain(array $ʟ_args): void
	{
		...
		echo '>
				...
				<li class="nav-item">
					<a href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("User:list")) /* line 62 */;
		echo '"';
		echo ($ʟ_tmp = array_filter([$presenter->isLinkCurrent('User:list') ? 'active' : null, 'nav-link'])) ? ' class="' . LR\Filters::escapeHtmlAttr(implode(" ", array_unique($ʟ_tmp))) . '"' : "" /* line 62 */;
		echo '>
						<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
							<svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
								 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Sign:in")) /* line 215 */;
		echo '">
						<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
';
		if (!$presenter->user->isLoggedIn()) /* line 284 */ {
			...
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Sign:in")) /* line 285 */;
			echo '">
...
';
			...
			echo LR\Filters::escapeHtmlText($presenter->user->getIdentity()->getData()['firstname']) /* line 292 */;
			echo ' ';
			echo LR\Filters::escapeHtmlText($presenter->user->getIdentity()->getData()['lastname']) /* line 292 */;
			echo '</span>
							</a>
';
		}
								...
								<li class="mb-2">
									<a class="dropdown-item border-radius-md" href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 321 */;
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":changeLocale!", ['locale' => 'cs'])) /* line 400 */;
		echo '">
										<div class="d-flex py-1">
											<div class="d-flex flex-column justify-content-center">
								...
								<li>
									<a class="dropdown-item border-radius-md" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":changeLocale!", ['locale' => 'en'])) /* line 409 */;
		echo '">
										<div class="d-flex py-1">
											<div class="d-flex flex-column justify-content-center">
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Sign:out")) /* line 420 */;
		echo '">
...
';
		$this->renderBlock('content', [], 'html') /* line 430 */;
	...
	<!--   Core JS Files   -->
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 555 */;
		echo '/assets/js/core/jquery.min.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 556 */;
		echo '/assets/js/core/popper.min.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 557 */;
	...
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 562 */;
		echo '/assets/js/datagrid.js"></script>

	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 564 */;
		echo '/assets/js/datagrid-instant-url-refresh.js"></script>

	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 566 */;
		echo '/assets/js/datagrid-spinners.js"></script>

	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 568 */;
		echo '/assets/js/plugins/perfect-scrollbar.min.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 569 */;
		echo '/assets/js/plugins/smooth-scrollbar.min.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 570 */;
	...
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 753 */;
